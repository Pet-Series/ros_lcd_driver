...
#
# -----Prerequisite------------------------------
# Pyhton library "rpi_lcd" that supports LCD text displays (20x4, 16x2 and other) via I2C converter.
# $ pip install rpi-lcd
#
# -----Prerequisite------------------------------
# <launch>
...
# Hardware: I2C interface: PC8574T - Piggyback on the backisde of the display.
